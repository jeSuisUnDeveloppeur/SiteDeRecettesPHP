...
<body class="d-flex flex-column min-vh-100">
    <div class="container">
        ...
        <h1 class="text-center mx-auto w-50 bg-primary text-white my-5 rounded-2 p-3">Site de recettes</h1>
        <h2 class="bg-primary d-inline p-2 mb-4 rounded-2 text-light">Connexion</h2>
        <!-- Formulaire de connexion -->
        <?php require_once(__DIR__ . '/login.php'); ?>
        <h3 class="bg-tertiary text-primary d-inline-block p-2 rounded">Les recettes</h3>
        <?php foreach (getRecipes($recipes) as $recipe) : ?>
            <article class="mt-5">
                ...
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item "><a class="link-info" href="recipes_comment.php?id=<?php echo($recipe['recipe_id']); ?>">commenter l'article</a></li>
